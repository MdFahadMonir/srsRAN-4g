...
{
  // std::cout << "dl_ri: " << metrics_->dl_ri << std::endl;
  ...
  *metrics_ = ue_metrics;
  ...
  // std::cout << "ue metrics: " << ue_metrics.dl_ri << std::endl;
  // std::cout << "dl_ri2: " << metrics_->dl_ri << std::endl;
...
void ue::metrics_dl_ri(uint32_t dl_ri)
{
  ...
  // std::cout << "ue ri: " << ue_metrics.dl_ri << std::endl;
  // std::cout << "ue pmi: " << ue_metrics.dl_pmi << std::endl;
  // std::cout << "input ri: " << dl_ri << std::endl;
}
...
void ue::metrics_dl_pmi(uint32_t dl_ri)
{
  ...
  // std::cout << "pmi_dlri: " << dl_ri << std::endl;
  // std::cout << "pmi: " << ue_metrics.dl_pmi << std::endl;
  // std::cout << "data - avg: " << (float)dl_ri - ue_metrics.dl_pmi << std::endl;
}

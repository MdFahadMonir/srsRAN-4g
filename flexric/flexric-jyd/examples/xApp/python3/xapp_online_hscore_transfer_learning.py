...
#### CONFIGURATION
####################
RUNTIME = 240  # Total runtime in seconds (allow multiple training cycles)
...
SPARSITY = 0.8
LEAKY = 0.2
TARGET_KPI_INDEX = 8  # ul_rssi is at index 8 in FEATURE_NAMES

# Training configuration
TRAINING_INTERVAL = 45  # Retrain h-net every 45 seconds (faster adaptation)
MIN_SAMPLES_FOR_TRAINING = 400  # Minimum samples before first training
BUFFER_SIZE = 1200  # Rolling buffer size (1200 samples = ~12 seconds of data @ 10ms interval)
    ...
    def handle(self, ind):
        if len(ind.ue_stats) > 0:
            ...
            kpi_sample = {
                ...
                'ul_rssi': ul_rssi,  # Use direct value (already in dBm)
